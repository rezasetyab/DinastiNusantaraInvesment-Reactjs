  ...
  return (
    <>
      <section className="mt-16">
        ...
        {/* <Carousel>
          <div>
            <img className="w-full md:h-[650px] " src="/image/full depan.png" alt="" />
          </div>
        </Carousel> */}
        ...
        <div className="py-5 px-8">
          ...
          <img className="mx-auto md:h-[600px] w-[800px]" src="/image/TK.jpg" alt="Tentang Kami" />
        </div>
        <div className="py-5 px-8">
        ...
        <div className="py-2 pb-6">
          ...
          <div className="grid md:grid-cols-3 gap-3 px-3">
            <div className="flex flex-col justify-start items-center text-center w-full shadow-xl border-2 hover:border-blue-600 p-4 mt-10">
              ...
              <img className="md:w-[150px] md:h-[180px] w-[110px] h-[130px] pb-3" src="/image/FE.png" alt="Financial Engineering" />
            ...
            <div className="flex flex-col justify-start items-center text-center w-full shadow-xl border-2 hover:border-blue-600 p-4 mt-10">
              <div className="flex flex-col items-center">
            <img className="md:w-[150px] md:h-[180px] w-[110px] h-[130px] pb-3" src="/image/PI.png" alt="Pengelolaan Investasi" />
            ...
            <div className="flex flex-col justify-start items-center text-center w-full shadow-xl border-2  hover:border-blue-600 p-4 mt-10">
              <div className="flex flex-col items-center">
            <img className="md:w-[150px] md:h-[180px] w-[110px] h-[130px] pb-3" src="/image/PBI.png" alt="Pengembangan Bisnis Internasional" />
